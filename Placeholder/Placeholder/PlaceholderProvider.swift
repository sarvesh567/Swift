...
extension PlaceholdersProvider {
    static var summer: PlaceholdersProvider {
        ...
        let xibPlaceholder = Placeholder(cellIdentifier: "CustomPlaceholderTVC", key: PlaceholderKey.custom(key: "XIB"))
    ...
    private static var starWarsPlaceholder: Placeholder {
        ...
        starwarsData.image = #imageLiteral(resourceName: "cart")
        starwarsData.action = NSLocalizedString("Done!", comment: "")
